    ...
    public String getTranslationKey(ItemStack stack) {
        for(int i = 0; i < EnumHandler.ItemUpgradeTypes.values().length; i++){
            if(stack.getItemDamage() == i){
                return this.getTranslationKey() + "_" + EnumHandler.ItemUpgradeTypes.values()[i].getName();
            } else {
                continue;
            }
        }
        return this.getTranslationKey() + "_" + EnumHandler.ItemUpgradeTypes.BASE_UPG.getName();
    }
